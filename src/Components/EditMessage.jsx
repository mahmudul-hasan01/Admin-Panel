                        ...
                        <form className="px-5 pb-5 pt-3 lg:pb-10 lg:pt-5 lg:px-10">
                            ...
                            <div className="space-y-5">
                                <div className="space-y-2 text-sm text-zinc-700 dark:text-zinc-400">
                                    <textarea className="rounded-lg border w-full h-40 border-[#CB087D] bg-transparent px-4 py-2 text-[#CB087D] focus:outline-none placeholder:text-black placeholder:text-xl" type="text" placeholder="Hello. How are you?" />
                                </div>
                            </div>
